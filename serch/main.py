...
def tokenize_search(file_text):
    ...
    stop_words_eng.extend(['Y', 's', 'a', 'v', 'v1', 'v2', 't', 'k', 'A.', 'V', '°C', 'M☉', 'G', 'T', 'K', 'C', 'A'])
    stop_words.extend(
        ['что', 'это', 'так', 'вот', 'макс.', 'мин.', 'м/с²', 'км²', 'км³', 'км/ч', 'м/с', ' м/с', 'км/с', 'кг', 'г/см³', 'быть', 'как', 'в', '—',
         'к', 'на', 'комм.', 'а.е.', 'км', 'см', 'см.', 'У', 'а', 'км/c', 'v', 'Mo', 'отн', 'i', 'сут', 'млрд', 'c', 'В',
         'с', 'мин', 'ч', '«', '»', 'А'])
